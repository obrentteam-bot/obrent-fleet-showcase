      ...
      >
        ...
        <SectionWrap active={section === 0}>
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-x-0 top-0 h-[35%] bg-gradient-to-b from-background via-background/75 to-transparent" />
            {/* Soft corner vignettes */}
            <div className="absolute inset-y-0 left-0 w-20 md:w-32 bg-gradient-to-r from-black/45 to-transparent dark:from-black/55" />
            <div className="absolute inset-y-0 right-0 w-20 md:w-32 bg-gradient-to-l from-black/45 to-transparent dark:from-black/55" />
          </div>
