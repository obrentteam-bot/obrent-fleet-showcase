...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "OBRENT — Premium Autovermietung in Mannheim. Luxusfahrzeuge für besondere Anlässe." },
      { name: "author", content: "OBRENT" },
      { property: "og:title", content: "OBRENT — Luxus Autovermietung Mannheim" },
      { property: "og:description", content: "OBRENT — Premium Autovermietung in Mannheim. Luxusfahrzeuge für besondere Anlässe." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "OBRENT" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "OBRENT — Luxus Autovermietung Mannheim" },
      { name: "twitter:description", content: "OBRENT — Premium Autovermietung in Mannheim. Luxusfahrzeuge für besondere Anlässe." },
    ],
    links: [
